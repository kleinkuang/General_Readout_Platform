...
HD_PWD='F:/General_Readout_Platform/gen1/fpga/demo_mcu/demo_mcu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_mcu_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_mcu_wrapper.tcl
