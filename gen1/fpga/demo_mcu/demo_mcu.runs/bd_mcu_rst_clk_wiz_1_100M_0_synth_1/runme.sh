...
HD_PWD='F:/General_Platform/fpga/demo_mcu/demo_mcu.runs/bd_mcu_rst_clk_wiz_1_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_mcu_rst_clk_wiz_1_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_mcu_rst_clk_wiz_1_100M_0.tcl
