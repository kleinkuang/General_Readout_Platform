...
HD_PWD='F:/General_Readout_Platform/gen1/fpga/demo_mcu/demo_mcu.runs/bd_mcu_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_mcu_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_mcu_xbar_0.tcl
