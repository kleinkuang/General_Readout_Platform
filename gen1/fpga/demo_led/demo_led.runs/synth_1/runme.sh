...
HD_PWD='F:/General_Platform/fpga/demo_led/demo_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demo_led.tcl
