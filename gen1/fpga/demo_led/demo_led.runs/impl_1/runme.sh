...
HD_PWD='F:/General_Platform/fpga/demo_led/demo_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demo_led.tcl -notrace
